...
impl PrintCharsInstruction {
    ...
    pub fn get_code() -> u16 { PRINT_CHARS_INSTRUCTION_CODE }
    ...
    pub fn execute(pointer: &mut usize, memory_managers: &mut MemoryManagers) {
        ...
        *pointer += size_of::<usize>();
        println!("{}", String::from_utf8_lossy(&memory_managers.variable_memory.memory[position..position+len]));
    }
}
